...
public class AvlTreeTest{
    ...
    class DeleteTest{
        ...
        public void testDeletingOnlyRightChildLeafNodes() {
            ...
            assertEquals("This test should return that the height of the top node is 1", 1, node1.getHeight());
        }

        @Test
        @DisplayName("Test checking that you can delete the left child")
        public void testDeletingOnlyLeftChildLeafNodes() {
            AvlNode<Integer> node1, node2, node3, node4;
